...
export default function JoinMeeting() {
  ...
  useEffect(() => {
    ...
    getMeetingData();
  }, [ userLoaded, createToast, navigate]);
  const appId=1595382880;
  const serverSecret="39bd9803e49888293135c8b85c96f95c";
  const myMeeting = async (element: any) => {
    ...
    zp?.joinRoom({
      ...
      sharedLinks: [
        {
          name: "Personal link",
          url: "wss://webliveroom1595382880-api.coolzcloud.com/ws",
        },
      ],
      scenario: {
